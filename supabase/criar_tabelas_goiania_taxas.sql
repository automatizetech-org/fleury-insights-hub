-- Cole e execute no Supabase (SQL Editor) para criar as tabelas do robô Goiânia Taxas e Impostos.
-- Corrige o erro: "Could not find the table 'public.municipal_tax_debts' in the schema cache"
...
-- RLS: permite ao robô (chave anon) inserir/atualizar. Corrige "violates row-level security policy".
